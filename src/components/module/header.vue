        ...
        <div class="header clearfix">
          ...
          <template v-if="siteType.length === 1">
            <ul class="header-ul clearfix">
              ...
              <!-- 超级合伙人 -->
              <!-- <li v-if="configHeaderOpen === '1'">
                <router-link to="/agentStatic">{{$t('public.hd.economic')}}<span></span></router-link>
              </li> -->
              <li class="line">
                |
              </li>
              <!-- 模拟交易 -->
              <li>
                <router-link to="/simulation">{{Internationalization.moni}}<span></span></router-link>
              </li>
              <!-- 双向评级系统 -->
              <li>
                 <router-link to="/dubble">{{Internationalization.pingji}}<span></span></router-link>
              </li>
              <!-- 个人量化工具 -->
              <li>
                <router-link to="/lianghua">{{Internationalization.gongju}}<span></span></router-link>
              </li>
              <li class="line">
                |
              </li>
              <!-- 白皮书 -->
              <!-- <li>
                <a href="#">{{Internationalization.baipishu}}<span></span></a>
              </li> -->
              <li @mouseover="over" @mouseout="out" v-if="downurl.app_page_url">
                  <a href="#">{{$t('main.app_download')}}<span></span></a>
          ...
          <div class="header-right">
            <ul class="rightNav">
              <template v-if="islogin">
                <template v-if="siteType.indexOf('otc') !== -1">
                  <li class="rightNav_item" v-if=" userInfor.otc_save_ad_on_off !== 0"> 
  ...
  computed: {
    ...
    Internationalization () {
      return {
        ...
        agent: this.$t('public.hd.economic'),//'经纪人管理',
        moni: this.$t('public.hd.moni'),//模拟交易
        pingji: this.$t('public.hd.pingji'),//双向评级系统
        gongju: this.$t('public.hd.gongju'),//个人量化工具,
        baipishu: this.$t('public.hd.baipishu')
      }
    }
  },
  watch: {
