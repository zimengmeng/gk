            ...
            <div class="funds-center">
                  ...
                  <div class="funds-content">
                    ...
                    <div class="fund-manage-top" v-if="coinlist">
                        ...
                        <div class="fund-manage-allassets">{{Internationalization.total_money}}: {{totalBalance}} <span>{{totalBalanceSymbol}}</span> <span cla> ≈ {{CNY}}</span></div>
                                  ...
                                  <tr v-if="item.checked">
                                    ...
                                    <td>
                                      <span class="opear">
                                        ...
                                        <span  class="opear">
                                          <a class="deff-texts" href="javascript:void(0)" @click="withdrawShow(key,'withdraw')" v-if="item.withdrawOpen">	{{Internationalization.withdraw}}
                                          </a>
                                  ...
                                  <tr v-if="item.isopen" class="rechargeShow">
                                    ...
                                    <td :colspan="row" >
                                      ...
                                      <div v-else class="rechargeCon clearfix">
                                        ...
                                        <div class="qrcode">
                                          <img class="qrcodeimg" v-if="addressQRCode" :src="addressQRCode"/>
                                        </div>
...
export default {
  ...
  components: {
    elDialog, VPagination, InlineInput, loadingModel, HeaderTop, FooterBottom, coManage, fundsAside,Header,Footer
  },
  computed: {
    ...mapState({
